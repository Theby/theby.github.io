...
tags: [ update, gdc, gdc2026, gamedev, indiedev, career, gamedesign, artdirection ]
category: blog
...
![Prince of Persia production plan]({{ '/assets/images/gdc/persia01.jpg' | relative_url }} "Prince of Persia production plan")
...
![Etude Lifecycle]({{ '/assets/images/gdc/owlcat01.jpg' | relative_url }} "Etude Lifecycle")
...
![Claire Obscur Conclusions]({{ '/assets/images/gdc/clair01.jpg' | relative_url }} "Claire Obscur Conclusions")
...
![Character Design Workflow]({{ '/assets/images/gdc/lovedeepspace01.jpg' | relative_url }} "Character Design Workflow")
...
![Studio Health]({{ '/assets/images/gdc/goodgamesfail01.jpg' | relative_url }} "Studio Health")
...
![Unity GDC event]({{ '/assets/images/gdc/unity01.jpg' | relative_url }} "Unity GDC event")
...
![Yotei movie inspirations]({{ '/assets/images/gdc/yotei01.jpg' | relative_url }} "Yotei movie inspirations")
...
![Silent Hill f combat]({{ '/assets/images/gdc/silenthillf01.jpg' | relative_url }} "Silent Hill f combat")
...
![Battle battle!]({{ '/assets/images/gdc/wicked01.jpg' | relative_url }} "Battle battle!")
...
![Taichiro Miyazaki]({{ '/assets/images/gdc/cc201.jpg' | relative_url }} "Taichiro Miyazaki")
...
![Risks on writing]({{ '/assets/images/gdc/mediailliterate01.jpg' | relative_url }} "Risks on writing")
